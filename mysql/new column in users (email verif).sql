...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 07, 2025 at 04:36 PM
...
INSERT INTO `users` (`userID`, `username`, `fname`, `lname`, `email`, `password`, `contactNo`, `birthday`, `gender`, `status`, `profilePicture`, `address`, `archive`, `userType`, `reset_otp`, `otp_expires_at`, `email_verification`) VALUES
(1, 'okim', 'Miko Allen', 'Santos', 'santosmikoallen@gmail.com', '$2y$12$5fiTMf0S/7ll.UcIeQYhIuLKKsuObtkuv4iWZT3ahxXaokqIR6ybm', '09292902337', '2003-03-26', 'Male', 0, 'http://192.168.1.198:8000/storage/profile_photos/1754898438_IMG_2646.jpeg', 'San Juan', 1, 'Admin', NULL, NULL, NULL),
(2, 'bibingka20', 'Mary Hannah', 'Reyes', 'reyesmaryhannahcaryl@gmail.com', '$2y$12$7aAuFyzyNrWoggmlULLs.uNvq.eDC/xdE5d47cWSVEMelo9yfx9J6', '09155467893', '2003-09-20', 'Female', 0, 'http://192.168.1.198:8000/storage/profile_photos/1754250971_ph-11134207-7ra0p-mchwszm552lqa1@resize_w450_nl.png', 'Malinis St', 1, 'Admin', NULL, NULL, NULL),
(3, 'nicolevarga', 'Nicole', 'Varga', 'nicolevarga19@icloud.com', '$2y$12$O5dvQVpUA64PqaGq5vTwiuNtkH4/tAGMPmn6mcXDhjSCqolXigfNK', '09155467893', '2003-08-20', 'Female', 0, 'http://192.168.1.198:8000/storage/profile_photos/1753979174_cn-11134207-7r98o-lqiyxv5mt6hkd2.webp', 'Guiguinto Bulacan', 1, 'Customer', NULL, NULL, NULL),
(4, 'mabu', 'Mabu', 'Dela Saint', 'itsmabu26@gmail.com', '$2y$12$iISS5zy1IcWR/fAN/MoArePI7z.CdGSc7X67N7Fz.e9hcoprwYzv.', '09292902337', '2003-03-26', 'Male', 0, 'http://192.168.1.198:8000/storage/profile_photos/1757255227_Screenshot 2024-02-28 214556.png', 'Taguig City', 1, 'Customer', NULL, NULL, NULL);
...
--
ALTER TABLE `favorites`
  MODIFY `favoriteID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=92;
