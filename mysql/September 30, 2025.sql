...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 30, 2025 at 01:44 PM
...
CREATE TABLE `booking` (
  ...
  `date` date NOT NULL,
  `studio_selection` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`studio_selection`)),
...
INSERT INTO `booking_addons` (`id`, `booking_id`, `addon_id`, `quantity`, `price`, `total`, `created_at`, `updated_at`) VALUES
(1, 28, 'portrait', 1, 49.00, 49.00, '2025-09-29 18:16:10', '2025-09-29 18:16:10'),
(2, 29, 'portrait', 1, 49.00, 49.00, '2025-09-29 18:28:03', '2025-09-29 18:28:03'),
(3, 30, 'grid', 1, 69.00, 69.00, '2025-09-29 18:56:27', '2025-09-29 18:56:27'),
(4, 31, 'pax', 1, 129.00, 129.00, '2025-09-29 19:04:35', '2025-09-29 19:04:35'),
(5, 32, 'portrait', 1, 49.00, 49.00, '2025-09-29 19:10:14', '2025-09-29 19:10:14'),
(6, 33, 'portrait', 1, 49.00, 49.00, '2025-09-29 19:15:33', '2025-09-29 19:15:33'),
(7, 34, 'backdrop', 1, 129.00, 129.00, '2025-09-29 19:17:07', '2025-09-29 19:17:07'),
(8, 35, 'portrait', 1, 49.00, 49.00, '2025-09-29 19:23:33', '2025-09-29 19:23:33'),
(9, 36, 'grid', 1, 69.00, 69.00, '2025-09-30 06:51:40', '2025-09-30 06:51:40'),
(10, 36, 'extra5', 1, 129.00, 129.00, '2025-09-30 06:51:40', '2025-09-30 06:51:40'),
(11, 37, '30', 1, 69.00, 69.00, '2025-09-30 08:43:46', '2025-09-30 08:43:46'),
(12, 37, '60', 1, 199.00, 199.00, '2025-09-30 08:43:46', '2025-09-30 08:43:46'),
(13, 38, '10', 2, 49.00, 98.00, '2025-09-30 08:47:54', '2025-09-30 08:47:54'),
(14, 38, '40', 3, 129.00, 387.00, '2025-09-30 08:47:54', '2025-09-30 08:47:54');
...
CREATE TABLE `notifications` (
  ...
  `label` enum('Booking','Payment','Reschedule','Cancellation','Reminder','Promotion','System','Gallery') DEFAULT NULL,
  `message` text NOT NULL,
...
CREATE TABLE `package_add_ons` (
  ...
  `type` enum('single','multiple','dropdown','') NOT NULL,
...
CREATE TABLE `payment_sessions` (
  ...
  `payment_type` enum('deposit','full','remaining') NOT NULL,
...
INSERT INTO `payment_sessions` (`id`, `booking_id`, `checkout_session_id`, `payment_type`, `payment_method_used`, `amount`, `status`, `paymongo_payment_id`, `created_at`, `updated_at`) VALUES
(1, 28, 'cs_eWcev5rko67AhjX854A9fUpC', 'full', NULL, 428.00, 'pending', NULL, '2025-09-29 18:16:12', '2025-09-29 18:16:12'),
(2, 29, 'cs_UvcDuWivEG2amrqy48MmuJ4b', 'deposit', NULL, 200.00, 'pending', NULL, '2025-09-29 18:28:04', '2025-09-29 18:28:04'),
(3, 30, 'cs_6SB22PZhykyDwViTcu6aj8du', 'deposit', NULL, 200.00, 'pending', NULL, '2025-09-29 18:56:29', '2025-09-29 18:56:29'),
(4, 31, 'cs_4SL8TNHPmngfJGxYDtXCyYdk', 'full', NULL, 828.00, 'pending', NULL, '2025-09-29 19:04:37', '2025-09-29 19:04:37'),
(5, 32, 'cs_LmgzFZ8Hv345FTQk89jz4m6s', 'full', NULL, 748.00, 'pending', NULL, '2025-09-29 19:10:16', '2025-09-29 19:10:16'),
(6, 33, 'cs_GQmmryipdNtMDN7tQ8D3uqwu', 'full', NULL, 428.00, 'pending', NULL, '2025-09-29 19:15:35', '2025-09-29 19:15:35'),
(7, 34, 'cs_dGtLVkJP52gCnYExoivohr23', 'full', 'PayMongo - PayMongo', 828.00, 'completed', NULL, '2025-09-29 19:17:08', '2025-09-29 19:22:41'),
(8, 35, 'cs_ngwhqk4NK7LZrTRLADmCSz4P', 'full', NULL, 428.00, 'pending', NULL, '2025-09-29 19:23:34', '2025-09-29 19:23:34'),
(9, 36, 'cs_DQTUJnUqxszoitBUHjmXLTv3', 'deposit', NULL, 200.00, 'pending', NULL, '2025-09-30 06:51:45', '2025-09-30 06:51:45'),
(10, 37, 'cs_GFW811UmYocv2zsjZJ7UARRS', 'full', NULL, 647.00, 'pending', NULL, '2025-09-30 08:43:48', '2025-09-30 08:43:48'),
(11, 38, 'cs_dHpEMyz8TaBPHYegnw1ag88W', 'full', NULL, 1384.00, 'pending', NULL, '2025-09-30 08:47:56', '2025-09-30 08:47:56');
...
CREATE TABLE `payment_transactions` (
  ...
  `status` enum('completed','failed','pending','refunded') NOT NULL DEFAULT 'completed',
...
ALTER TABLE `booking_addons`
  ADD PRIMARY KEY (`id`),
  ADD KEY `booking_addons_booking_id_index` (`booking_id`);
...
--
ALTER TABLE `transaction`
  MODIFY `transId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
